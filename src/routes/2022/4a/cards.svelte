...
<main>
	...
	<div class="button-panel">
		<span
			...
			class="border-black border-4 rounded p-2 ml-3 mt-10 "
		>
			...
			<div class="border rounded">
				...
				<table class="table">
					...
					<tbody>
						<tr
							><td
								><div class="btn btn-dark" on:click={() => players[cur].c++}>
									{player.c}
								</div></td
							><td
								><div class="btn btn-danger" on:click={() => players[cur].h++}>
									{player.h}
								</div></td
							><td
								><div class="btn btn-primary" on:click={() => players[cur].o++}>
									{player.o}
								</div></td
							><td
								><div

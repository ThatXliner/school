<script>
	...
	$: c = a.div(b); // TODO: apparently we can set precision?
	const EXAMPLES = [[new Decimal(4), new Decimal(16)]].concat(
		[...Array(2)].map(() => {
...
<div class="card w-fit bg-base-100 shadow-xl">
	<div class="card-body">
		...
		<div class="bg-base-200 rounded-box text-3xl p-9 mx-auto">
			...
			/>) = {@html katex.renderToString(`\\ln{\\frac{${a}}{${b}}} = \\ln{${c}}`)}
		</div>
		<div class="btn-group">
